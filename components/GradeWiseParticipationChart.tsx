...
export const GradeWiseParticipationChart: React.FC<GradeWiseParticipationChartProps> = ({ data, totalRegistered }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm h-full">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-semibold text-gray-800">Grade-Wise Participation</h3>
